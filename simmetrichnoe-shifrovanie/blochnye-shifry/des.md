...
```
Слабые ключи DES: E(x, key) = x (возможно, не для всех x)
=================
0101-0101-0101-0101
FEFE-FEFE-FEFE-FEFE
1F1F-1F1F-0E0E-0E0E
...
Частично слабые ключи: E(E(x, key1), key2) = x (вроде, для всех x)
==================
key1, key2:
...
!!! Перемена sbox местами не влияет на слабые ключи

Пример DES на python
